...
class CoursePaymentWebView extends StatefulWidget {
  final String courseId;

  const CoursePaymentWebView({super.key, required this.courseId});

  @override
  _CoursePaymentWebViewState createState() => _CoursePaymentWebViewState();
}

class _CoursePaymentWebViewState extends State<CoursePaymentWebView> {
  ...
  Future<String> _loadUrl() async {
    ...
    String url =
        '$apiUrl${Constants.coursepaymentGatewayUrl}${widget.courseId}/$studentId';
